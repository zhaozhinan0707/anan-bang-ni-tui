...
const PR_CONFIG = {
  ...
  MODELS: [
    ...
    { value: 'mimo-v2.6-pro',     label: '小米 MiMo-V2.6-Pro 视觉（推荐）' },
    { value: 'mimo-v2.6-flash',   label: '小米 MiMo-V2.6-Flash 视觉（高性价比）' },
    { value: 'mimo-v2.6-pro-ultraspeed', label: '小米 MiMo-V2.6-Pro-UltraSpeed 视觉（极速）' },
    { value: 'mimo-v2-flash',     label: '小米 MiMo-V2-Flash 视觉（旧版）' },
    { value: 'mimo-v2.5-pro',     label: '小米 MiMo-V2.5-Pro 视觉（旧版）' },
    { value: 'mimo-v2.5',         label: '小米 MiMo-V2.5 视觉（旧版）' },
    // 中转站
  ...
  DEFAULT_API_BASES: {
    ...
    'mimo-v2.6-pro':     'https://token-plan-cn.xiaomimimo.com/v1',
    'mimo-v2.6-flash':   'https://token-plan-cn.xiaomimimo.com/v1',
    'mimo-v2.6-pro-ultraspeed': 'https://token-plan-cn.xiaomimimo.com/v1',
    'mimo-v2-flash':     'https://token-plan-cn.xiaomimimo.com/v1',
    'mimo-v2.5-pro':     'https://token-plan-cn.xiaomimimo.com/v1',
